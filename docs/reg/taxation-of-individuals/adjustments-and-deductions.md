...
| Self-employed retirement plans | §404 | Per plan limits |
...
| Coverage | Annual Limit | Minimum Deductible | Max Out-of-Pocket |
|---|---|---|---|
...
| Agreement Date | Payor Treatment | Payee Treatment |
|---|---|---|
| **Before January 1, 2019** | Deductible (adjustment to income) | Included in gross income |
| **On or after January 1, 2019** | **Not** deductible | **Not** included in gross income |
...
| Type | Contributions | Tax Treatment of Contributions | Distributions |
|---|---|---|---|
| **Traditional (Deductible)** | Pre-tax | Deductible as adjustment to income | Taxed as ordinary income |
| **Traditional (Nondeductible)** | After-tax | Not deductible | Only earnings taxed |
| **Roth** | After-tax | Not deductible | **Tax-free** if qualified |
...
As computed on Schedule SE, the taxpayer deducts **50%** of self-employment tax as an adjustment to income. See the [Other Individual Taxes](./other-individual-taxes.md) chapter for the full SE tax computation.
...
|---|---|
| **SEP-IRA** | 25% of net SE earnings (after SE tax deduction), up to \$70,000 |
...
| Status | Additional Amount (2025 Approx.) |
|---|---|
...
$$
\text{AGI Floor} = \$80{,}000 \times 7.5\% = \$6{,}000
$$

$$
\text{Deductible Amount} = \$9{,}500 - \$6{,}000 = \$3{,}500
$$
...
| Tax | Deductible? |
|---|---|
| State and local **income** taxes | Yes (or sales tax — choose one) |
| State and local **sales** taxes | Yes (if elected instead of income tax) |
| State and local **real estate** taxes | Yes |
...
- **I**nheritance and estate taxes (state-level)
- **B**usiness taxes (deducted on Schedule C/E, not Schedule A)
...
|---|---|
| **Ordinary Income Property** | Property that would generate ordinary income or short-term capital gain if sold (e.g., inventory, assets held ≤ 1 year, depreciated personal-use assets) |
| **Long-Term Capital Gain (LTCG) Property** | Appreciated property held for more than one year (e.g., stocks, real estate, collectibles) |
...
| Contribution Type | Overall Limit |
|---|---|
| Cash only | 60% of AGI |
| Mix of cash and property | 50% of AGI |
...
$$
\text{Max ordinary income property deduction} = \$100{,}000 \times 50\% = \$50{,}000
$$

$$
\text{Max LTCG property deduction} = \$100{,}000 \times 30\% = \$30{,}000
$$
...
$$
\text{Deductible Loss} = \left[\min(\Delta\text{FMV},\ \text{Basis}) - \text{Reimbursement} - \$100\right] - 10\% \times \text{AGI}
$$
...
$$
\text{Section 199A Deduction} = 20\% \times \text{QBI}
$$
...
|---|---|---|
| **QTB** | Any trade or business **other than** an SSTB or the business of being an employee | Manufacturing, retail, real estate, construction |
| **SSTB** | A trade or business involving the performance of services in specified fields | Health, law, accounting, consulting, athletics, financial services, brokerage |
