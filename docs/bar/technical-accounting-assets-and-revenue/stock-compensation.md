...
**Example — Bear Co. RSUs**
On January 1, Year 1, Bear Co. grants 5,000 RSUs to an executive. Key terms:
| Item | Value |
|------|-------|
...
On January 1, Year 1, Polar Inc. grants 6,000 cash-settled SARs to employees. Key terms:
| Item | Value |
|------|-------|
