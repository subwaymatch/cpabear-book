...
**Example — Polar Inc.** is evaluating a new inventory management system costing \$150,000 to implement. The system is expected to reduce carrying costs by \$45,000 per year over five years.
...
**Example — Bear Co.** projects net income of \$200,000 based on 10,000 units sold at \$50 each with variable costs of \$30 per unit and fixed costs of \$100,000. If the selling price drops by 10%:
