...
flowchart TD
    ...
    A --> C[Liabilities]
    A --> D[Stockholders' Equity]
    B --> B1[Current Assets]
    B --> B2[Noncurrent Assets]
    C --> C1[Current Liabilities]
    C --> C2[Noncurrent Liabilities]
    D --> D1[Contributed Capital]
    D --> D2[Retained Earnings]
    D --> D3[AOCI]
    D --> D4[Treasury Stock - Contra]
```
...
flowchart TD
    ...
    subgraph Current Liabilities
        CL1[Payables]
        CL2[Accrued Liabilities]
        CL3[Unearned Revenue]
        CL4[Current Portion of LTD]
    end
    subgraph Noncurrent Liabilities
        NL1[Bonds Payable]
        NL2[Lease Liabilities]
        NL3[Deferred Tax Liabilities]
        NL4[Pension Obligations]
    end
```
