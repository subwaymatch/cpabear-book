...
1. **Inquiries** of management and others within the entity about:
...
2. **Analytical procedures** applied to the financial data, such as:
...
3. If revision is necessary, consider whether management is taking **appropriate action** to inform users who may be relying on the financial statements
