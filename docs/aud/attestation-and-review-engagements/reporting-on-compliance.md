...
1. **Obtains management's written assertion** about the entity's compliance with specified requirements
2. Plans and performs procedures to obtain **reasonable assurance** about whether the entity complied in all material respects
3. Issues an **opinion** on compliance (positive assurance)

### Agreed-Upon Procedures on Compliance

In an AUP engagement, the CPA:

1. Performs only the **specific procedures** agreed to by the specified parties
2. Reports **factual findings** without expressing an opinion or conclusion
3. Issues a report that is generally **restricted** to the specified parties
