...
const sidebars: SidebarsConfig = {
  ...
  barSidebar: [
    ...
    {
      type: "category",
      label: "Business Analysis – Historical Analysis",
      items: [
        "bar/business-analysis-historical/financial-statement-analysis",
        "bar/business-analysis-historical/non-financial-and-non-gaap-measures",
        "bar/business-analysis-historical/managerial-and-cost-accounting",
      ],
    },
    {
      type: "category",
      label: "Business Analysis – Prospective Analysis",
      items: [
        "bar/business-analysis-prospective/budgeting-forecasting-and-projection",
        "bar/business-analysis-prospective/capital-structure",
        "bar/business-analysis-prospective/investment-alternatives",
        "bar/business-analysis-prospective/risk-management",
        "bar/business-analysis-prospective/economic-and-market-influences",
      ],
    },
    {
      type: "category",
      label: "Technical Accounting – Assets, Revenue, and Compensation",
      items: [
        "bar/technical-accounting-assets-and-revenue/indefinite-lived-intangible-assets",
        "bar/technical-accounting-assets-and-revenue/internally-developed-software",
        "bar/technical-accounting-assets-and-revenue/revenue-recognition",
        "bar/technical-accounting-assets-and-revenue/stock-compensation",
        "bar/technical-accounting-assets-and-revenue/research-and-development-costs",
      ],
    },
    {
      type: "category",
      label: "Technical Accounting – Combinations, Derivatives, and Reporting",
      items: [
        "bar/technical-accounting-combinations-and-reporting/business-combinations",
        "bar/technical-accounting-combinations-and-reporting/consolidated-financial-statements",
        "bar/technical-accounting-combinations-and-reporting/derivatives-and-hedge-accounting",
        "bar/technical-accounting-combinations-and-reporting/leases",
        "bar/technical-accounting-combinations-and-reporting/public-company-reporting-topics",
        "bar/technical-accounting-combinations-and-reporting/employee-benefit-plans",
      ],
    },
    {
      type: "category",
      label: "Governmental Financial Statements",
      items: [
        "bar/governmental-financial-statements/government-wide-financial-statements",
        "bar/governmental-financial-statements/governmental-funds-financial-statements",
        "bar/governmental-financial-statements/proprietary-funds-financial-statements",
        "bar/governmental-financial-statements/fiduciary-funds-financial-statements",
        "bar/governmental-financial-statements/notes-to-financial-statements",
        "bar/governmental-financial-statements/managements-discussion-and-analysis",
        "bar/governmental-financial-statements/budgetary-comparison-reporting",
        "bar/governmental-financial-statements/required-supplementary-information",
        "bar/governmental-financial-statements/financial-reporting-entity",
      ],
    },
    {
      type: "category",
      label: "Governmental Transactions and Items",
      items: [
        "bar/governmental-transactions-and-items/deriving-government-wide-financial-statements",
        "bar/governmental-transactions-and-items/net-position-and-components",
        "bar/governmental-transactions-and-items/fund-balances-and-components",
        "bar/governmental-transactions-and-items/capital-assets-and-infrastructure",
        "bar/governmental-transactions-and-items/general-and-proprietary-long-term-liabilities",
        "bar/governmental-transactions-and-items/interfund-activity-and-transfers",
        "bar/governmental-transactions-and-items/nonexchange-revenue-transactions",
        "bar/governmental-transactions-and-items/expenditures-and-expenses",
        "bar/governmental-transactions-and-items/budgetary-accounting-and-encumbrances",
      ],
    },
  ],
  iscSidebar: [
    "isc/index",
    {
      ...
      items: [
        "isc/information-systems/it-infrastructure",
        "isc/information-systems/enterprise-and-accounting-information-systems",
        "isc/information-systems/availability",
        "isc/information-systems/change-management",
      ],
    },
    {
      type: "category",
      label: "Data Management",
      items: ["isc/data-management/data-management"],
    },
    {
      type: "category",
      label: "Regulations, Standards, and Frameworks",
      items: [
        "isc/regulations-standards-and-frameworks/regulations-standards-and-frameworks",
      ],
    },
    {
      type: "category",
      label: "Security",
      items: [
        "isc/security/threats-and-attacks",
        "isc/security/mitigation",
        "isc/security/security-testing",
      ],
    },
    {
      type: "category",
      label: "Confidentiality, Privacy, and Incident Response",
      items: [
        "isc/confidentiality-privacy-and-incident-response/confidentiality-and-privacy",
        "isc/confidentiality-privacy-and-incident-response/incident-response",
      ],
    },
    {
      type: "category",
  ...
  tcpSidebar: [
    ...
    {
      type: "category",
      label: "Individual Compliance and Tax Planning",
      items: [
        "tcp/individual-compliance-and-tax-planning/individual-compliance-and-tax-planning",
      ],
    },
    {
      type: "category",
      label: "Passive Activity and At-Risk Loss Limitations",
      items: [
        "tcp/passive-activity-and-at-risk-loss-limitations/passive-activity-and-at-risk-loss-limitations",
      ],
    },
    {
      type: "category",
      label: "Gift Taxation",
      items: ["tcp/gift-taxation/gift-taxation"],
    },
    {
      type: "category",
      label: "Personal Financial Planning",
      items: ["tcp/personal-financial-planning/personal-financial-planning"],
    },
    {
      type: "category",
