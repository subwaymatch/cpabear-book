...
import { BookOpen, FileText, Scale, Shield, Users, Calculator, ArrowRight, Sparkles, } from "lucide-react";
    ...
    const sections = [
        {
            ...
            description: "Master GAAP, financial statements, and government/nonprofit accounting standards.",
            icon: FileText,
            color: "lime",
            link: "/far",
        },
        {
            ...
            description: "Learn audit procedures, professional standards, and attestation ethics.",
            icon: Shield,
            color: "blue",
            link: "/aud",
        },
        {
            ...
            title: "REG",
            fullName: "Regulation",
            description: "Study federal taxation, business law, and professional ethics.",
            icon: Scale,
            color: "emerald",
            link: "/reg",
        },
        {
            ...
            description: "Understand IT controls, cybersecurity, and data governance frameworks.",
            icon: Calculator,
            color: "orange",
            link: "/isc",
        },
        {
            ...
            description: "Deep dive into tax planning strategies and compliance requirements.",
            icon: BookOpen,
            color: "rose",
            link: "/tcp",
        },
        {
            ...
            description: "Explore financial analysis, planning, and performance metrics.",
            icon: Users,
            color: "violet",
            link: "/bar",
        },
      ...
      <div className={styles.homePage}>
        <section className={styles.hero} aria-label="Hero">
          <div className={styles.heroBackdrop} aria-hidden="true">
            ...
            {FLOATING_SYMBOLS.map((s, i) => (<span key={i} className={styles.floatingSymbol} style={{
                top: s.top,
                left: s.left,
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroCopy}>
              ...
              <h1 className={styles.heroTitle}>
                ...
                <span className={styles.rotatorWrap} aria-live="polite">
                  ...
                  {ROTATING_WORDS.map((word, i) => (<span key={word} className={`${styles.rotatorWord} ${i === wordIndex ? styles.rotatorActive : ""}`}>
                      {word}
                    </span>))}
                </span>
                <br/>
            ...
            <div className={styles.heroArt} aria-hidden="true">
              ...
              <img src="/img/logo-variants/cpabear-lime.svg" alt="" className={styles.bear}/>
          ...
          <div className={styles.ticker} aria-hidden="true">
            <div className={styles.tickerTrack}>
              {[...TICKER_TERMS, ...TICKER_TERMS].map((term, i) => (<span key={i} className={styles.tickerItem}>
                  {term}
                </span>))}
            </div>
          </div>
