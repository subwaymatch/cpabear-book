    ...
    <div className={styles.detailPanel}>
      ...
      <div style={{ padding: "0 1.5rem 1rem" }}>
        ...
        <div className={styles.testletGrid}>
          {section.testlets.map((t) => (
            <div className={styles.testletCard} key={t.label}>
...
export default function Blueprint2026() {
  ...
  return (
    <Layout
      title="CPA Exam Blueprint 2026"
      description="Comprehensive guide to the 2026 Uniform CPA Examination Blueprint — exam structure, content areas, skill allocations, and detailed section breakdowns."
    >
        ...
        <div className={styles.container}>
                  ...
                  {sections.map((s) => (
                    <tr key={s.id}>
                      <td>
                        <span className={styles.sectionBadge}>
                          <span
                            className={`${styles.sectionDot} ${dotMap[s.id]}`}
                          />
                          {s.code}
                        </span>
                      </td>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.barChartGroup}>
              {sections.map((s) => (
                <div className={styles.barChartCard} key={s.id}>
                ...
                <tbody>
                  {sections.map((s) => (
                    <tr key={s.id}>
                      ...
                      {s.testlets.map((t) => (
                        <td className={styles.tdCenter} key={t.label}>
                          {t.count}
                        </td>
                      ))}
                    </tr>
